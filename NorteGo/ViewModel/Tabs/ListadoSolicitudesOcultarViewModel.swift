//
//  ListadoSolicitudesOcultarViewModel.swift
//  NorteGo
//
...
class ListadoSolicitudesOcultarViewModel: ObservableObject {
    ...
    func ocultarSolicitudesRX(idToken: String, id: Int, tipo: Int, completion: @escaping (Result<JSON, Error>) -> Void) {
